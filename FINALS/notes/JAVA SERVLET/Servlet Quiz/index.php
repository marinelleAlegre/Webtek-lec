		...
		<form action="grade.php" method="post" id="quiz">
            ...
            <ol>
				...
				<div>
					...
					<label for="question-1-answers-B"> B) The service() method is called whenever the servlet is invoked.</label>
				</div>
				<div>
					<input type="radio" name="question-1-answers" id="question-1-answers-C" value="C" required/> 
					<label for="question-1-answers-C"> C) Both A and B.</label>
				</div>
				<div>
				...
				<div>
					...
					<li>
						...
						<div>
							...
							<label for="question-3-answers-B"> B) initialize(), service(), destroy()</label>
						</div>
						<div>
					...
					<div>
						...
						<label for="question-4-answers-B"> B) request.getContextPath()</label>
					</div>
					<div>
						<input type="radio" name="question-4-answers" id="question-4-answers-C" value="C" required/> 
						<label for="question-4-answers-C"> C) response.getContextPath()</label>
					</div>
					<div>
					...
					<div>
						...
						<label for="question-5-answers-B"> B) The init() method is not called again and again for each user request.</label>
					</div>
					<div>
					...
					<div>
						...
						<label for="question-6-answers-B"> B) session.getId()</label>
					</div>
					<div>
						<input type="radio" name="question-6-answers" id="question-6-answers-C" value="C" required/> 
						<label for="question-6-answers-C"> C) session.getActiveId()</label>
					</div>
					<div>
					...
					<div>
						...
						<label for="question-7-answers-B"> B) Locale.getISO3Language</label>
					</div>
					<div>
						<input type="radio" name="question-7-answers" id="question-7-answers-C" value="C" required/> 
						<label for="question-7-answers-C"> C) request.getISO3Language()</label>
					</div>
					<div>
					...
					<div>
						...
						<label for="question-8-answers-B"> B) response.getRemoteUser</label>
					</div>
					<div>
						<input type="radio" name="question-8-answers" id="question-8-answers-C" value="C" required/> 
						<label for="question-8-answers-C"> C) Header.getRemoteUser()</label>
					</div>
					<div>
					...
					<div>
						...
						<label for="question-9-answers-B"> B) response.sendredirect(location)</label>
					</div>
					<div>
						<input type="radio" name="question-9-answers" id="question-9-answers-C" value="C" required/> 
						<label for="question-9-answers-C"> C) header.sendRedirect(location)</label>
					</div>
					<div>
