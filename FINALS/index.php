                    ...
                    <nav class="navbar navbar-default">
                        ...
                        <div class="collapse navbar-collapse main-menu" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav navbar-right">
                                ...
                                <li>
                                    <a class="page-scroll" href="#about">Notes</a>
                                </li>
                                <li>
                                    <a class="page-scroll" href="#reviews">Team</a>
                                </li>		              	
                                <li>
                                    <a class="page-scroll" href="#blog">References</a>
                                </li>		              	              	              	
                                <li>
                                    <a class="page-scroll" href="../FINALS/login/login1.php">Login</a>
                                </li>		              			              
                            </ul>
                        </div>
                    </nav>
                            ...
                            <div class="testimonial-carousel item-indicator">
                                <div class="single-testi text-center">
                                    ...
                                    <div class="testi-text text-center">
                                        <h4>Marinelle Alegre</h4>
                                        <span class="guest-rev">2152394@slu.edu.ph</span>
                                    </div>
                                </div>
                                ...
                                <div class="single-testi text-center">
                                    ...
                                    <div class="testi-text text-center">
                                        <h4>John Martin Baladad</h4>
                                        <span class="guest-rev">2153882@slu.edu.ph</a></span>
                                    </div>
                                </div>
                                <!-- End single item -->
                                <div class="single-testi text-center">
								...
								<div class="single-testi text-center">
                                    <div class="testi-img">
                                        <img src="img/testimonial/test4.jpg" alt="">
                                    </div>
                                    <div class="testi-text text-center">
                                        <h4>Denyse Rae Cayadi</h4>
                                        <span class="guest-rev">2146790@slu.edu.ph</a></span>
                                    </div>
                                </div>
								<div class="single-testi text-center">
                                    <div class="testi-img">
                                        <img src="img/testimonial/test5.jpg" alt="">
                                    </div>
                                    <div class="testi-text text-center">
                                        <h4>Steven Mark Gerald Mangati</h4>
                                        <span class="guest-rev">2166769@slu.edu.ph</a></span>
                                    </div>
                                </div>
                            </div>
                        </div>
